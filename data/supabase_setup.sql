...
-- MIGRATION: WALI KELAS OPTION 3 (AUTO-TRIMMING)
ALTER TABLE kelas ADD COLUMN IF NOT EXISTS rombel_nama text DEFAULT NULL;
ALTER TABLE kelas ADD COLUMN IF NOT EXISTS nama_kustom text DEFAULT NULL;
